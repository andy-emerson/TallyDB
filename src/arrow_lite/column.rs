...
///
/// ```
/// use tallydb::{Buffer, Column, ColumnType, KeyColumn, NumericColumn, NumericData};
///
...
impl Column {
    ...
    ///
    /// ```
    /// use tallydb::{Buffer, Column, NumericColumn, NumericData, Bitmap};
    ///
...
///
/// ```
/// use tallydb::{Buffer, NumericColumn};
///
